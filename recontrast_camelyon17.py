...
from dataset import Camelyon17Train, Camelyon17Test
...
def train(_class_, unode1_checkpoint=None, unode2_checkpoint=None):
    ...
    train_data = Camelyon17Train(transform=data_transform)
    ...
    print('len test1: ', len(test_data1))
    print('len test2: ', len(test_data2))
