...
from dataset import AptosTrain, AptosTest, ImageNetExposure
...
def train(_class_, unode1_checkpoint=None, unode2_checkpoint=None, count=-1, augmented_view=True):
    ...
    train_data = AptosTrain(transform=train_data_transforms,  count=count)
    ...
    if unode1_checkpoint is not None:  # encoder
        ...
        encoder, bn = resnet18(pretrained=True, progress=True, unode_path=unode1_checkpoint, fc=True)
