...
def train(_class_, shrink_factor=None, total_iters=2000, evaluation_epochs=250, training_using_pad=False, max_ratio=0, augmented_view=False, batch_size=16, model='wide_res50'):
    ...
    visualize_random_samples_from_clean_dataset(test_data2, f'test data LDC')
    ...
    auroc_px_list = {"main":0, "shifted1":0, "shifted2":0}
    auroc_px_list_best = {"main":0, "shifted1":0, "shifted2":0}

    auroc_sp_list = {"main":0, "shifted1":0, "shifted2":0}
    auroc_sp_list_best = {"main":0, "shifted1":0, "shifted2":0}

    auroc_aupro_px_list = {"main":0, "shifted1":0, "shifted2":0}
    auroc_aupro_px_list_best = {"main":0, "shifted1":0, "shifted2":0}
...
if __name__ == '__main__':
    ...
    result_list = {"main":[], "shifted1":[], "shifted2":[]}
    result_list_best = {"main":[], "shifted1":[], "shifted2":[]}
    pad_size = ["main", "shifted1", "shifted2"]
    item = 'rsna'
    print(f"+++++++++++++++++++++++++++++++++++++++{item}+++++++++++++++++++++++++++++++++++++++")
