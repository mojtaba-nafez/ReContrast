...
def train(_class_, model='wide_res50', batch_size=16, total_iters=2000, evaluation_epochs=250, image_size=224):
    ...
    visualize_random_samples_from_clean_dataset(test_dataloader_landbg, f'test data isic1')
    visualize_random_samples_from_clean_dataset(test_dataloader_waterbg, f'test data isic2')
